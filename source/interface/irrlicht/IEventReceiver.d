...
enum EEVENT_TYPE : uint
{
	...
	* Linux: send a ClientMessage via XSendEvent to the Irrlicht
		...
		* casted to int and used as UserData1 and UserData2.
...
enum E_MOUSE_BUTTON_STATE_MASK : uint
{
	EMBSM_LEFT    = 0x01,
	EMBSM_RIGHT   = 0x02,
	EMBSM_MIDDLE  = 0x04,
...
/// SEvents hold information about an event. See irrlicht.IEventReceiver for details on event handling.
struct SEvent
{
	 ...
	 * irrlicht.IrrlichtDevice.activateJoysticks() has been called, an event of
	 * this type will be generated once per joystick per IrrlichtDevice.run()
...
struct SJoystickInfo
{
	 ...
	 * irrlicht.SJoystickEvent Joystick ID. 
	 */
	ubyte Joystick;
