...
module irrlicht.IReferenceCounted;
...
class IReferenceCounted
{
	...
	uint referenceCount() const @property
	{
		version(CUSTOM_MEMORY_MANAGMENT)
	...
	string debugName() const @property
	{
		return mDebugName;
	}
	...
	protected
	{
		...
		void debugName(string newName) @property
		{
			mDebugName = newName;
		}
	}
	private
	{
		version(CUSTOM_MEMORY_MANAGMENT)
		{
			...
			__gshared size_t mReferenceCounter;
		}
