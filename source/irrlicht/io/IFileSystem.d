...
*/
interface IFileSystem : IReferenceCounted
{
	...
	*/
	bool addFileArchive(const Path filename, bool ignoreCase=true,
			bool ignorePaths=true,
			E_FILE_ARCHIVE_TYPE archiveType=E_FILE_ARCHIVE_TYPE.EFAT_UNKNOWN,
			string password="",
			ref IFileArchive retArchive=null);
	...
	*/
	...
	{
		return addFileArchive(filename, ignoreCase, ignorePaths, E_FILE_ARCHIVE_TYPE.EFAT_ZIP);
	}
	...
	*/
	...
	{
		return addFileArchive(filename, ignoreCase, ignorePaths, E_FILE_ARCHIVE_TYPE.EFAT_FOLDER);
	}
	...
	*/
	...
	{
		return addFileArchive(filename, ignoreCase, ignorePaths, E_FILE_ARCHIVE_TYPE.EFAT_PAK);
	}
	...
	*/
	...
	/** 
	*Returns: a Pointer to the created IFileList is returned. After the list has been used
